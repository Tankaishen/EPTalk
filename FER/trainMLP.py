...
sys.path.append('../')
sys.path.append('/share/home/202321044040/data/code/DEEPTalk/')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', type=str, default='FER/checkpoint/config.yaml', help='Path to the config file')
