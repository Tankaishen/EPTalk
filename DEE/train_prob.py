...
@torch.no_grad()
def val_one_epoch(args, model, val_dataloader , device, processor, writer, affectnet_feature_extractor=None, epoch=None, log_wandb = True):
    cumulative_loss = 0
    step = 0
    model.eval()
    criterion = model.criterion
...
def main(args): 
    ...
    for epoch in range(1, args.epochs+1):
        ...
        val_one_epoch(args, DEE, val_dataloader, device,processor, affectnet_feature_extractor=affectnet_feature_extractor,
